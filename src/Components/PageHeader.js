              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between">
                  ...
                  <div class="metric-label text-success font-weight-bold align-self-center">
                    <span class="icon-shape icon-xs rounded-circle text-success bg-success-light">
              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between">
                  ...
                  <div class="metric-label align-self-center text-danger font-weight-bold">
                    <span class="icon-shape icon-xs rounded-circle text-danger bg-danger-light bg-danger-light ">
          ...
          <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12 mb-4">
            <div class="card shadow-sm h-100">
              ...
              <div class="card-footer">
                <p class="h1 font-weight-bold mb-0">
              ...
              <div class="card-body p-0">
                <ul class="social-sales list-group list-group-flush">
                  <li class="list-group-item d-flex align-items-center">
                    <span class="icon-shape icon-lg rounded-circle text-white bg-facebook mr-2">
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    ...
                    <span class="ml-auto text-dark">99 Sales</span>
                  </li>
                  <li class="list-group-item d-flex align-items-center">
                    ...
                    <span class="ml-auto text-dark">76 Sales</span>
                  </li>
                  <li class="list-group-item d-flex align-items-center">
                    <span class="icon-shape icon-lg rounded-circle text-white bg-pinterest mr-2">
                      <i class="fab fa-pinterest-p"></i>
                    </span>
                    <span class="">Pinterest</span>
                    <span class="ml-auto text-dark">56 Sales</span>
                  </li>
                  <li class="list-group-item d-flex align-items-center">
                    <span class="icon-shape icon-lg rounded-circle text-white bg-googleplus mr-2">
                      <i class="fab fa-google-plus-g"></i>
                    </span>
                    <span class="">Google Plus</span>
                    <span class="ml-auto text-dark">36 Sales</span>
                  </li>
                </ul>
              </div>
            ...
            <div class="card shadow-sm h-100">
              ...
              <div class="card-body p-0">
                <ul class="traffic-sales list-group list-group-flush">
                  <li class="list-group-item d-flex align-items-center pt-3 pb-3">
                    <span class="traffic-sales-name">Direct</span>
                    <span class="ml-auto">
                      $4000.00{" "}
                      <span class="icon-shape icon-xs rounded-circle text-success ml-4 bg-success-light">
                        <i class="fa fa-fw fa-arrow-up"></i>
                      </span>
                  ...
                  <li class="list-group-item d-flex align-items-center pt-3 pb-3">
                    <span class="traffic-sales-name">Search</span>
                    <span class="ml-auto">
                      $3123.00{" "}
                      <span class="icon-shape icon-xs rounded-circle text-success ml-4 bg-success-light">
                        <i class="fa fa-fw fa-arrow-up"></i>
                  ...
                  <li class="list-group-item d-flex align-items-center pt-3 pb-3">
                    <span class="traffic-sales-name">Social</span>
                    <span class="ml-auto">
                      $3099.00{" "}
                      <span class="icon-shape icon-xs rounded-circle text-success ml-4 bg-success-light">
                        <i class="fa fa-fw fa-arrow-up"></i>
                  ...
                  <li class="list-group-item d-flex align-items-center pt-3 pb-3">
                    <span class="traffic-sales-name">Referrals</span>
                    <span class="ml-auto">
                      $2220.00{" "}
                      <span class="icon-shape icon-xs rounded-circle text-danger ml-4 bg-danger-light">
                        <i class="fa fa-fw fa-arrow-down"></i>
                      </span>
            ...
            <div class="card shadow-sm h-100">
              ...
              <div class="card-body p-0">
                <ul class="country-sales list-group list-group-flush">
                  <li class="country-sales-content list-group-item pt-3 pb-3">
                    <span class="mr-2">
                  ...
                  <li class="list-group-item country-sales-content pt-3 pb-3">
                    <span class="mr-2">
